...
function App() {
  ...
  useEffect(()=>{
    const getProducts = async()=>{
      const data=await fetch(`http://localhost:5000/api/products?search=${searchQuery}`);
        ...
        <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div className="w-full md:w-1/2">
                    <form className="flex items-center">
                        ...
                        <div className="relative w-full">
                            ...
                            <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search transaction" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    {products.map((product,_id)=>(
                          ...
                          <td className="mx-auto">
                            <img src={product.image} placeholder="product-image" className="w-12 h-14"/>
                          </td>
            ...
            <nav className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4" aria-label="Table navigation">
                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    of
                    <span className="font-semibold text-gray-900 dark:text-white px-2">60</span>
                </span>
